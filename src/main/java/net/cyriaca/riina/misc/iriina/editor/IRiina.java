...
import net.cyriaca.riina.misc.iriina.editor.ui.*;
...
public class IRiina {
    ...
    private IRiinaPreferences prefs = null;
    private List<LocaleChangeListener> localeChangeListeners = null;
    private View currentView = View.InitStateNoWindow;
    private PreWelcomeFrame preWelcomeFrame = null;
    private WelcomeFrame welcomeFrame = null;
    private NewProjectDialogFrame newProjectDialogFrame = null;
    private MapImportFrame mapImportFrame = null;
    private OpenProjectDialogFrame openProjectDialogFrame = null;
    private ProjectLoadFrame projectLoadFrame = null;
    private EditorFrame editorFrame = null;
    private AboutFrame aboutFrame = null;
    private PreferencesFrame preferencesFrame = null;
